...
function endGame() {
    ...
    btn2.addEventListener(`click`, function(){window.location.reload()} );
    
    document.querySelector(`.a_btn`).style.display ="block";
  }


gsap.from(".a1", {x:-200, duration:5, delay:6, opacity:0, });
gsap.from(".a2", {x:200, duration:5, delay:6, opacity:0 });
